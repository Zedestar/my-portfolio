    ...
    <div className="w-full h-full flex flex-col justify-between">
      <div className="flex-1">
        <div className="h-full w-full flex flex-col gap-4">
          <div className="mt-10 text-center space-y-3 font-semibold px-4 py-10 bg-[#5c7f6e] text-white">
            <h1 className="text-4xl font-extrabold inline-block border-b-4 border-black pb-1">
              Services
            </h1>
            <p className="text-lg">We bring your ideas to life online.</p>
            <p className="text-lg">
              Crafting modern websites and powerful mobile apps.
            </p>
            <p className="text-lg">
              All with stunning, intuitive user-first design.
            </p>
          </div>
