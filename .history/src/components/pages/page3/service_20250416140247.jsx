    ...
    <div className="w-full h-full flex flex-col justify-between">
      <div className="flex-1">
        <div className="h-full w-full flex flex-col bg-orange-400 gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 m-4">
            <div className="custom-green p-4 bg-custom-green rounded-lg w-auto h-auto space-y-2 shadow-lg text-white hover:shadow-2xs transition">
              <AiFillLayout className="text-6xl" />
              <p className="text-2xl font-bold">Web development</p>
              <p>Responsive website user friendly</p>
            </div>
            <div className="custom-green p-4 bg-custom-green rounded-lg w-auto h-auto space-y-2 shadow-lg text-white">
              <AiFillLayout className="text-6xl" />
              <p className="text-2xl font-bold">Web development</p>
              <p>Responsive website user friendly</p>
            </div>
